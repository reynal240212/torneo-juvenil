...
// Mapa para cachear jugadores por id
...
async function mostrarPlantilla(equipoId) {
  ...
  plantillaContainer.innerHTML = `
    <div class="col-12 text-center">
      ...
      <p class="mt-2">Cargando plantilla...</p>
    </div>`;
      ...
      <div class="col-12 col-sm-6 col-md-4 col-lg-3">
        <div class="card player-card h-100"
          ...
          <div class="card-body d-flex flex-column text-center">
            ...
            <p class="card-text player-position text-muted mb-2">
    ...
    playerModal.addEventListener("show.bs.modal", function (event) {
      ...
      modalBody.innerHTML = `
        <ul class="list-group list-group-flush">
          ...
          <li class="list-group-item d-flex justify-content-between align-items-center">
            Tarjetas Azules:
            <span class="badge bg-info rounded-pill fs-6 text-dark">
              ${jugador.T_AZ || 0}
            </span>
          </li>
        </ul>
