    ...
    playerModal.addEventListener('show.bs.modal', function (event) {
      ...
      modalBody.innerHTML = `
        <ul class="list-group list-group-flush">
          ...
          <li class="list-group-item d-flex justify-content-between align-items-center">
            Tarjetas Amarillas:
            <span class="badge bg-warning rounded-pill fs-6 text-dark">${jugador.tarjetas_amarillas || 0}</span>
          </li>
          <li class="list-group-item d-flex justify-content-between align-items-center">
            Tarjetas Rojas:
            <span class="badge bg-danger rounded-pill fs-6">${jugador.tarjetas_rojas || 0}</span>
          </li>
          <li class="list-group-item d-flex justify-content-between align-items-center">
            Tarjetas Azules:
            <span class="badge bg-info rounded-pill fs-6 text-dark">${jugador.tarjetas_azules || 0}</span>
          </li>
        </ul>
      `;
    });
