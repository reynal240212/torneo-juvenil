...
const supabaseKey = "eyJhbGciOiJIJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImN3bHZwem9zc3FtcHV6ZHBqcnNoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjE0MDc5NTIsImV4cCI6MjA3Njk4Mzk1Mn0.PPq8uCEx9Tu1B6iBtS2eCHogGSRaxc5tWPF8PZnU-Go";
...
async function mostrarPlantilla(equipoId) {
  ...
  jugadores.forEach(jugador => {
    ...
    // He añadido la clase col-xl-2 para que se vean más tarjetas en pantallas anchas
    const cardHTML = `
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (playerModal) {
    playerModal.addEventListener('show.bs.modal', function (event) {
      ...
      // ===== CAMBIO AQUÍ: Usamos la notación de corchetes para las tarjetas =====
      modalBody.innerHTML = `
